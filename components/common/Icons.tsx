...
export const Cog6ToothIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-.962a8.51 8.51 0 0 1 5.97 5.97c.045.552-.421 1.02-.962 1.11l-.542.09a8.51 8.51 0 0 0-5.97-5.97l-.09-.542ZM9.594 9.594c.09.542.56 1.007 1.11.962a8.51 8.51 0 0 1 5.97 5.97c.045.552-.421 1.02-.962 1.11l-.542.09a8.51 8.51 0 0 0-5.97-5.97l-.09-.542Z" />
...
export const ChatBubbleBottomCenterTextIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 0 1-2.53-.388A.75.75 0 0 0 8.25 20.25a.75.75 0 0 1-.75-.75c0-.414.336-.75.75-.75h.375A9.76 9.76 0 0 1 12 18.75c4.97 0 9-3.694 9-8.25s-4.03-8.25-9-8.25S3 7.444 3 12c0 .482.046.952.134 1.405l.853 3.84a.75.75 0 0 0 .73.595h.375a.75.75 0 0 1 .75.75.75.75 0 0 0 .75.75h.375a.75.75 0 0 0 .75-.75.75.75 0 0 1 .75-.75h.375a9.76 9.76 0 0 1 2.53.388.75.75 0 0 0 .98-.98 9.76 9.76 0 0 1-.388-2.53c0-4.97 3.694-9 8.25-9Z" />
    </svg>
);
